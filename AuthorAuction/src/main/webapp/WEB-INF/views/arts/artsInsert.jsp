		...
		<div style="display: flex;">
			...
			<div
				...
				<div style="width: 70%; height: 95%;">
					...
					<div style = "border:1px solid black; border-bottom:1px solid black; height: 80%;">
...
// 	});
	...
	document.getElementById('register').addEventListener('click', ()=>{
		...
		formData.append("proWidth", parseInt(document.getElementsByClassName('forminfo')[3].value.trim()));
		formData.append("proHeight", parseInt(document.getElementsByClassName('forminfo')[4].value.trim()));
		formData.append("proPrice", parseInt(document.getElementsByClassName('forminfo')[5].value.trim()));
		formData.append("proAmount", parseInt(document.getElementsByClassName('forminfo')[6].value.trim()));
