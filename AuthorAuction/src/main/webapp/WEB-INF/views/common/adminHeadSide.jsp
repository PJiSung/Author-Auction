        ...
        <aside style="width:15%;">
            ...
            <div class="sideBar">
            	<ul type="circle">
            		...
            		<li><div class="sideBtn" style="margin-top:10%;" onclick="location.href='artsadmin.ar'">판매 작품</div></li>
            		<li><div class="sideBtn" style="margin-top:10%;" onclick="location.href='admOrderList.adod'">주문 관리</div></li>
            		<li><div class="sideBtn" style="margin-top:10%;" onclick="location.href='searchList.adco'">위탁 문의</div></li>
