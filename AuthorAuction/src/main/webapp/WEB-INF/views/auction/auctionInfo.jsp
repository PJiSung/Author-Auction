          ...
          <div class="contents-container container-md">
            <ul class="contents-list">
              <li class="contents-item">
                ...
                <br>
                <h4 class="h4"> 1. 낙찰 및 우선 순위 </h4>
                <br> 경매 낙찰은 시작 후 최고가를 제시한 응찰자에게 경매작품이 낙찰되며, 자동응찰 &gt; 수동 응찰 순으로 우선적으로 낙찰 기회가 주어집니다.<br> 동일한 금액의 응찰이 발생할 경우 서버시각에 따라 먼저 응찰금액을 입력하신 분에게 우선 순위가 주어집니다.<br> 응찰 시 응찰 단위 기준으로 금액이 상승합니다.<br><br><br>
                <h4 class="h4"> 2. 낙찰 확인 </h4>
                <br> 낙찰 시, 이메일로 낙찰확인서가 발송 됩니다. 혹은 홈페이지 로그인 &gt; 마이페이지 &gt; 온라인 경매관리&gt;결제/구매내역에서 낙찰 금액 및 수수료를 확인 하실 수 있습니다.<br><br><br>
                <h4 class="h4"> 3. 구매 수수료 </h4>
                <br> 낙찰가에 따른 낙찰수수료는 기본적으로 아래의 방침을 따릅니다. 단, 내부정책에 따라 다른 수수료율이 적용되는 경우가 있습니다.<br>
                <label>온라인 경매 일괄</label> : 19.8% (부가세 별도) 낙찰가, 구매가 이미지 들어가야함.<br><br><br>
                <h4 class="h4"> 4. 결제 안내 </h4>
                <br> 홈페이지 카드결제 이미지 넣어야함
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="contents-container container-md">
            <ul class="contents-list">
              <li class="contents-item">
                ...
                <br> 이미지 넣어야함 <p class="contents-desc"> 서울 및 수도권 지역 무료 배송 진행 </p>
