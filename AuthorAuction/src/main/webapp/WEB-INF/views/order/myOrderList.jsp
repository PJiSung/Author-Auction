          	...
          	<div class="contents-search">
	            ...
	            <div class="contents-form">
	              ...
	              <div class="inputset inputset-lg">
	                ...
	                <input type="text" class="inputset-input form-control" placeholder="Serach" name="keyword" value="${ s.keyword }">
	              </div>
	            </div>
	          </div>
	          <div class="tableset">
	              ...
	              <tbody>
	                <c:forEach items="${ list }" var="o">
		                ...
		                <tr class="orderTableTr" onclick="selectOrderDetail(event, this)">
		                  <td class="tableset-mobile">${ o.ordNo }<input type="hidden" value="${ o.proNo }" id="proNo"></td>
...
document.getElementsByClassName('inputset-icon icon-right icon-search btn')[0].addEventListener('click', () =>{
