...
//					selectReply.action = 'updateReply.re';
					form.submit();
				}	
			})
		};
			            ...
			            <div class="reply-form">
				            <div class="replyEnroll">
				              <div class="contents-group-bottom">
					             <textarea class="inputset-textarea textarea-keyup form-control" required="" id="textarea" name="recReply" style="resize: none;"></textarea>
				              </div>
				              <br>
			              	  <div class="contents-group-bottom">
