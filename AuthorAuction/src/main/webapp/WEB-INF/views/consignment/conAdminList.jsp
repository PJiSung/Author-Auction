...
<script type="text/javascript">
	...
	function start() {
		console.log(document.querySelectorAll("input"))	//4번 5번
		keepSort();
	...
	const openEnrollModal = (data) =>{
		const td = data.parentElement.parentElement;
		console.log(td);
		const $data = $(data);
...
<body>
	...
	<div class="modal_overlay" style="display: none; z-index: 1; height: 150%;">
		<div id="content-allOver-cover" style="width: 100%; height: 100%; position: fixed; z-index: 1;">
			<div id="forWidthAndHeight" style="width: 70%; height: 80%; margin: auto; background-color: white; margin-top: 1%; display: table;">
				<form action="insertAuction.adac" method="post" id="auctionForm">
					...
					<div style="display:flex; text-align:center; align-items: center; justify-content: center;">
						<div style="width: 100%;">
							<div style="width: 25%; display: inline-block; margin-right: 3.125%;">
								대표 사진<br>
								<span id="presentPic"><img class="pictures" src="" style="width: 250px; height: 250px;"></span>
							</div>
							<div style="width: 25%; display: inline-block; margin-right: 3.125%; margin-left: 3.125%;">
								전면 사진<br>
								<span id="firstPic"><img class="pictures" src="" style="width: 250px; height: 250px;"></span>
							</div>
							<div style="width: 25%; display: inline-block; margin-left: 3.125%;">
								후면 사진<br>
								<span id="secondPic"><img class="pictures" src="" style="width: 250px; height: 250px;"></span>
							</div>
						</div>
					</div>
					<div style="width: 100%; text-align: right; margin: 2% 0 2% 0;">
