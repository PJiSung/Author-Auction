	              ...
	              <label>
	                ...
	                <div class="body">
	                  <label style="margin-left: 15rem;">
	                    ...
	                    <input type="number" class="inputset-input form-control" aria-label="내용" required="" name="conWidth" style="width: 34rem; display:inline-block"> X <input type="number" name="conHeight" class="inputset-input form-control" aria-label="내용" required="" style="width: 34rem; display:inline-block">
	                    <br><br>
	                    <a style="display:inline-block; width: 15%; text-align: center;">제작연도</a>
	                    <input type=" number" class="inputset-input form-control" aria-label="내용" required="" name="conYear" style="width: 70rem; display:inline-block">
	                    <br><br>
	                    <a style=" display: inline-block; width: 15%; text-align: center;">희망가</a>
	                    <input type="number" class="inputset-input form-control" aria-label="내용" required="" name="conHope" style="width: 70rem; display: inline-block">
	                    <br><br>
	                    <div>
